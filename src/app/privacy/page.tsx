      ...
      <div className="container mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="text-foreground/80 mt-12 space-y-10">
          <section>
            ...
            <p>
              We collect information you provide directly when using Lineup
              Legends:
            </p>
            <ul className="mt-3 list-disc space-y-2 pl-6">
              <li>
                Account information (email, name, profile data) when you sign up
                via Google OAuth or email/password
              </li>
              <li>Profile and banner images you upload</li>
              <li>
                Lineups you create, ratings you give, and other in-app activity
              </li>
              <li>Feedback and support requests you submit</li>
            </ul>
            <p className="mt-3">
              We also automatically collect certain technical information, such
              as your IP address, browser type, and device information, when you
              access the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6">
              ...
              <li>
                Display your profile, lineups, and content to other users as
                intended by the Service
              </li>
              <li>Respond to your feedback and support requests</li>
              <li>
                Monitor and analyze usage patterns to improve the user
                experience
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              Service (e.g., hosting, authentication). These providers are
              contractually obligated to protect your data and use it only for
              the purposes we specify. We may also disclose information if
          ...
          <section>
            ...
            <p>
              ...
              Essential cookies are required for the Service to function. You
              can configure your browser to refuse cookies, though some features
          ...
          <section>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6">
              <li>
                <strong>Google OAuth:</strong> Used for sign-in. Google&apos;s
                privacy policy applies to data shared with Google during
                authentication.
              </li>
              <li>
                <strong>AWS S3:</strong> Used to store profile and banner images
                you upload. Data is stored in secure cloud infrastructure.
              </li>
              <li>
                <strong>CloudFront CDN:</strong> Used to deliver images and
                static assets efficiently. Content may be cached at edge
                locations.
              </li>
            </ul>
            <p className="mt-3">
          ...
          <section>
            ...
            <p>
              ...
              13, please contact us and we will take steps to delete that
              information.
            </p>
          </section>
