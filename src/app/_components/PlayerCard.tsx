...
export function PlayerCard({
  ...
  return (
    <button
      ...
      onClick={handleClick}
      disabled={disabled}
      className="group relative flex w-12 flex-col items-center sm:w-[4.5rem]"
    >
      {/* Player Cell - Square with off-white background and value-based glow */}
      <div
        className={`relative h-12 w-12 overflow-hidden bg-[#f2f2f2] transition-all duration-200 sm:h-[4.5rem] sm:w-[4.5rem] ${
